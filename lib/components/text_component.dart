  ...
  Widget build(BuildContext context) {
    if (listOfText.isEmpty) {
      return GestureDetector(
        onTap: onTextPressed,
        child: Container(
          padding: bgColor != null ? const EdgeInsets.all(10) : null,
      ...
      if (listOfTextStyle.length > listOfText.length) {
        throw ArgumentError(
          'Length of list of TextStyles cannot '
          'be greater than the List of text',
        );
      } else if (listOfOnPressedFunction.length > listOfText.length) {
        throw ArgumentError(
          'Length of list of Pressed Functions cannot '
          'be greater than the List of text',
        );
      }
      {
              ...
              recognizer: TapGestureRecognizer()
                ..onTap = () {
                  if (t < listOfOnPressedFunction.length) {
                    if (listOfOnPressedFunction[t] != null) {
